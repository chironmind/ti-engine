// Node wrapper: load the wasm-pack nodejs target (CommonJS) via createRequire.
// The nodejs target instantiates synchronously, so init is a no-op here.
import { createRequire } from "module";
const require = createRequire(import.meta.url);

// Load the generated CJS glue from wasm-pack (nodejs target)
const wasm = require("./dist/node/ti_engine.js");
...
// For API parity with web/bundler wrappers, export a no-op async init.
